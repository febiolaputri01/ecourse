...
<div class="row">
    <div class="col-md-12">
        <div style="padding-bottom: 10px;">
            <a href="#tambahproduk" role="button" class="btn btn-primary" data-toggle="modal">Tambah Pengajar</a>
        </div>
                ...
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="formAddPengalaman" action="<?= base_url(uri_string() . '/add_produk') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-header">
                            ...
                            <h3 class="smaller lighter blue no-margin">Tambah Pengajar</h3>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <!-- <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> -->
                                    <strong>Peringatan!</strong><br>
                                        Max Dimension : 180 x 160 (px)<br>
                                        Allowed Image : JPG | PNG
                                </div>

                                <div class="col-md-12">
                                    <label>Foto Pengajar</label>
                                    <input type="file" class="form-control" name="foto_pengajar" id="input_foto5" required>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="deskripsi_pengajar" id="input_deskripsi" placeholder="Deskripsi Pengajar"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($value->foto_pengajar) { ?>
                                    <img src="<?= base_url('assets/img/' . $value->foto_pengajar) ?>" width="100">
                                <?php } ?>
                            </td>
                            <td><?= $value->nama_pengajar ?></td>                            
                            <td><?= $value->deskripsi_pengajar ?></td>
                            <td>
                                <button type="button" class="btn btn-primary btn-xs" onclick="edit_produk('<?= $value->id_pengajar ?>')">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->id_pengajar ?>')">
