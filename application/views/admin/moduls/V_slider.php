                            ...
                            <div class="row">
                                ...
                                <!-- <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> -->
                                    <strong>Peringatan!</strong><br>
                                        Max Dimension : 1920 x 850 (px)<br>
                                        Allowed Image : JPG | PNG
                                </div>

                                <div class="col-md-12">
                                    <label>Gambar Slider</label>
                                    <input type="file" class="form-control" name="foto_slider" id="input_foto5" required>
                                </div>
                            </div>
                        </div>
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($value->foto_slider) { ?>
                                    <img src="<?= base_url('assets/img/' . $value->foto_slider) ?>" width="100">
                                <?php } ?>
                            </td>
                            <td>
