...
<div class="row">
    <div class="col-md-12">
        <div style="padding-bottom: 10px;">
            <a href="#tambahproduk" role="button" class="btn btn-primary" data-toggle="modal">Tambah Tentang</a>
        </div>
                ...
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="formAddPengalaman" action="<?= base_url(uri_string() . '/add_produk') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-header">
                            ...
                            <h3 class="smaller lighter blue no-margin">Tambah Tentang</h3>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <!-- <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> -->
                                    <strong>Peringatan!</strong><br>
                                        Max Dimension : 690 x 420 (px)<br>
                                        Allowed Image : JPG | PNG
                                </div>

                                <div class="col-md-12">
                                    <label>Foto Tentang</label>
                                    <input type="file" class="form-control" name="foto_tentang" id="input_foto5" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Nama Tentang</label>
                                    <input type="text" class="form-control" name="nama_tentang" placeholder="Nama Tentang" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Deskripsi Tentang</label>
                                    <textarea class="form-control" name="deskripsi_tentang" id="input_deskripsi" placeholder="Deskripsi Tentang"></textarea>
                                </div>
                            </div>
                        </div>
                ...
                if (count($result) > 0) {
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value->deskripsi_tentang ?></td>
                            <td>
                                <button type="button" class="btn btn-primary btn-xs" onclick="edit_produk('<?= $value->id_tentang ?>')">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->id_tentang ?>')">
